          ...
          <div className="row">
            ...
            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
              ...
              <div className="content">
                <label>Ghi chú:</label>
                <span>
                  Placeat qui quia ex minus esse. Velit quos voluptate vero fuga
                  perferendis facere aut aut. Nemo voluptate minima consequatur
                  asperiores autem adipisci aut.
                </span>
              </div>
            </div>
          </div>
