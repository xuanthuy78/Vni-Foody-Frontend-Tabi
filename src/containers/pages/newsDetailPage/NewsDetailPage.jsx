                ...
                <div className="content-detail">
                  ...
                  <div className="writer">
                    <p>
                      ...
                      số 3, 11 và 12) <br />
                      Quý khách vui lòng mang theo chứng minh thư nhân dân hoặc
                      các giấy tờ tương đương thể hiện ngày sinh nhật trùng với
                      ngày nhận bánh <br />
                      Mỗi khách hàng chỉ được nhận 1 bánh tặng miễn phí
                      <br />
                      Chỉ áp dụng với các đơn hàng có giá trị trên 250.000đ{' '}
                      <br />
                      Cửa hàng tặng miễn phí tối đa 10 bánh/ 1 ngày cho 10 người
                      đăng kí đầu tiên <br />
                    </p>
                  </div>
                  <div className="icon">
